...
function submitForm(){
    ...
    const productNameElement = document.querySelector('h1[data-i18n="ProstaVive_title"]');
    const productName = productNameElement ? productNameElement.innerText.trim() : "ProstaVive"; // Default if not found
