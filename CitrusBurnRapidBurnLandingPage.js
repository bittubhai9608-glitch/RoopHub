...
function submitForm(){
    ...
    const productNameElement = document.querySelector('h1'); // Assuming H1 contains product name
    const productName = productNameElement ? productNameElement.innerText.trim() : "CitrusBurn"; // Default if not found
