...
try:
    ...
    # Pakka karein ki sheet ka naam "RoopHub Leads" hi hai
...
def ai_reply(message, lang):
    ...
    if lang == "hi":
        if "hello" in msg: return "Namaste 🙏 aapka swagat hai! Aap kis product ke bare me jana chahte ho?"
        elif "problem" in msg: return "Koi baat nahi 👍 batayein, main help karunga."
